...
alberta_2022 <- alberta_causes_death %>%
  filter(calendar_year == 2022)

# Calculate summary statistics by cause
summary_stats_2022 <- alberta_2022 %>%
  summarize(
...
summary_stats_2022_df <- data.frame(
  `Min Deaths` = summary_stats_2022$Min,
  `Mean Deaths` = summary_stats_2022$Mean,
  `Max Deaths` = summary_stats_2022$Max,
  `SD` = summary_stats_2022$SD,
  `Var` = summary_stats_2022$Var,
  `N` = summary_stats_2022$N
)

# Print the table using kable
kable(
  summary_stats_2022_df,
  col.names = col_names,
  align = align,
  digits = 0,
  booktabs = TRUE,
...
@tbl-data-4 shows the summary of statistic of total deaths of 2022 in Alberta. In this table, we notice that the mean, 723, is different to the variance, 355,047.
...
Following an exploratory analysis of the dataset,

The ultimate model is presented below.
